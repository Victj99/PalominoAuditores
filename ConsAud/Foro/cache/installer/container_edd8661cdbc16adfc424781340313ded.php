...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000387897090000000044b29b0f(
...
class phpbbtemplatetwiglexer_00000000387897090000000044b29b0f extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5cff228e7df12472540331 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5cff228e7df20148921292 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5cff228e7dee2641133589 = array(
    ...
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, 'set_environment', array('env' => $env), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;

        return $this->valueHolder5cff228e7df12472540331->set_environment($env);
    }
    ...
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;

        return $this->valueHolder5cff228e7df12472540331->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;

        return $this->valueHolder5cff228e7df12472540331->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5cff228e7df20148921292 = $initializer;
    }
    ...
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, '__get', array('name' => $name), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;

        if (isset(self::$publicProperties5cff228e7dee2641133589[$name])) {
            return $this->valueHolder5cff228e7df12472540331->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5cff228e7df12472540331;
    ...
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;
    ...
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, '__isset', array('name' => $name), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;
    ...
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, '__unset', array('name' => $name), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;
    ...
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, '__clone', array(), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;

        $this->valueHolder5cff228e7df12472540331 = clone $this->valueHolder5cff228e7df12472540331;
    }

    public function __sleep()
    {
        $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, '__sleep', array(), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;

        return array('valueHolder5cff228e7df12472540331');
    }
    ...
    {
        return $this->initializer5cff228e7df20148921292;
    }
    ...
    {
        return $this->initializer5cff228e7df20148921292 && ($this->initializer5cff228e7df20148921292->__invoke($valueHolder5cff228e7df12472540331, $this, 'initializeProxy', array(), $this->initializer5cff228e7df20148921292) || 1) && $this->valueHolder5cff228e7df12472540331 = $valueHolder5cff228e7df12472540331;
    }
    ...
    {
        return null !== $this->valueHolder5cff228e7df12472540331;
    }
    ...
    {
        return $this->valueHolder5cff228e7df12472540331;
    }
